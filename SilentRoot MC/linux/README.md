...
This is the **Linux-optimized version** of SilentRoot MC Checker with full feature parity to the Windows version.
...
- ✅ **Cross-Distribution** - Works on Ubuntu, Debian, Fedora, Arch, etc.
- ✅ **Executable Scripts** - chmod +x for direct execution
